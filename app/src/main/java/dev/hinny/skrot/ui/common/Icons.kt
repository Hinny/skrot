...
fun ProgramIcon.vector(): ImageVector = when (this) {
    ...
    ProgramIcon.GYM_BICEPS -> vectorRes(R.drawable.ic_om_biceps)
    ProgramIcon.GYM_LEG -> vectorRes(R.drawable.ic_om_leg)
    ProgramIcon.GYM_FIST -> vectorRes(R.drawable.ic_om_fist)
    ProgramIcon.GYM_FIST_BUMP -> vectorRes(R.drawable.ic_om_fist_bump)
    ProgramIcon.GYM_SWORDS -> vectorRes(R.drawable.ic_om_swords)
    ProgramIcon.GYM_LIFTER -> vectorRes(R.drawable.ic_om_lifter)

    // Objects with attitude — OpenMoji black (CC BY-SA 4.0)
    ProgramIcon.EM_DYNAMITE -> vectorRes(R.drawable.ic_om_dynamite)
    ProgramIcon.EM_BEER -> vectorRes(R.drawable.ic_om_beer)
    ProgramIcon.EM_BEERS -> vectorRes(R.drawable.ic_om_beers)
    ProgramIcon.EM_MEDAL_1ST -> vectorRes(R.drawable.ic_om_medal_1st)
    ProgramIcon.EM_MEDAL_2ND -> vectorRes(R.drawable.ic_om_medal_2nd)
    ProgramIcon.EM_MEDAL_3RD -> vectorRes(R.drawable.ic_om_medal_3rd)
    ProgramIcon.EM_MEDAL_SPORTS -> vectorRes(R.drawable.ic_om_medal_sports)
    ProgramIcon.EM_MEDAL_MILITARY -> vectorRes(R.drawable.ic_om_medal_military)
    ProgramIcon.EM_CHAINS -> vectorRes(R.drawable.ic_om_chains)
    ProgramIcon.EM_MAGNET -> vectorRes(R.drawable.ic_om_magnet)
    ProgramIcon.EM_BALANCE_SCALE -> vectorRes(R.drawable.ic_om_balance_scale)
    ProgramIcon.EM_CIGARETTE -> vectorRes(R.drawable.ic_om_cigarette)
    ProgramIcon.EM_PILL -> vectorRes(R.drawable.ic_om_pill)
    ProgramIcon.EM_PLASTER -> vectorRes(R.drawable.ic_om_plaster)
    ProgramIcon.EM_SHIELD -> vectorRes(R.drawable.ic_om_shield)
    ProgramIcon.EM_BOMB -> vectorRes(R.drawable.ic_om_bomb)
    ProgramIcon.EM_KEY -> vectorRes(R.drawable.ic_om_key)
    ProgramIcon.EM_KEY_OLD -> vectorRes(R.drawable.ic_om_key_old)
    ProgramIcon.EM_GEAR -> vectorRes(R.drawable.ic_om_gear)
    ProgramIcon.EM_SKULL -> vectorRes(R.drawable.ic_om_skull)
    ProgramIcon.EM_SKULL_BONES -> vectorRes(R.drawable.ic_om_skull_bones)
    ProgramIcon.EM_FLAG_CHEQUERED -> vectorRes(R.drawable.ic_om_flag_chequered)
    ProgramIcon.EM_STOPWATCH -> vectorRes(R.drawable.ic_om_stopwatch)
    ProgramIcon.EM_HOURGLASS -> vectorRes(R.drawable.ic_om_hourglass)
    ProgramIcon.EM_BATTERY -> vectorRes(R.drawable.ic_om_battery)
    ProgramIcon.EM_ICE -> vectorRes(R.drawable.ic_om_ice)
    ProgramIcon.EM_MILK -> vectorRes(R.drawable.ic_om_milk)
    ProgramIcon.EM_MEAT -> vectorRes(R.drawable.ic_om_meat)
    ProgramIcon.EM_EGG -> vectorRes(R.drawable.ic_om_egg)
    ProgramIcon.EM_BONE -> vectorRes(R.drawable.ic_om_bone)
    ProgramIcon.EM_HAMMER -> vectorRes(R.drawable.ic_om_hammer)
    ProgramIcon.EM_HAMMER_WRENCH -> vectorRes(R.drawable.ic_om_hammer_wrench)
    ProgramIcon.EM_CROWN -> vectorRes(R.drawable.ic_om_crown)
    ProgramIcon.EM_GEM -> vectorRes(R.drawable.ic_om_gem)
    ProgramIcon.EM_DNA -> vectorRes(R.drawable.ic_om_dna)
    ProgramIcon.EM_STETHOSCOPE -> vectorRes(R.drawable.ic_om_stethoscope)
    ProgramIcon.EM_TEST_TUBE -> vectorRes(R.drawable.ic_om_test_tube)
    ProgramIcon.EM_MOAI -> vectorRes(R.drawable.ic_om_moai)
    ProgramIcon.EM_BRICK -> vectorRes(R.drawable.ic_om_brick)
    ProgramIcon.EM_AXE -> vectorRes(R.drawable.ic_om_axe)
    ProgramIcon.EM_LOTION -> vectorRes(R.drawable.ic_om_lotion)
